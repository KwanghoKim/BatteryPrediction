...
target_log_dir = "logs/logs_9B061FFBA000ST"
...
train_target_dirs =["1st", "2nd", "3rd", "4th", "5th", "6th", "7th"]
...
test_target_dirs =["8th"]

for train_target_dir in train_target_dirs:
  train_data.extend(model.parse_data_from_dir(os.path.join("logs/logs_9B061FFBA000ST/train_dataset", train_target_dir)))


for test_target_dir in test_target_dirs:
  test_data.extend(model.parse_data_from_dir(os.path.join("logs/logs_9B061FFBA000ST/test_dataset", test_target_dir)))
