...
def launch_youtube_with_link(link):
  exec("am start -a android.intent.action.VIEW " + link)

def quit_youtube():
  exec("am force-stop com.google.android.youtube")
    ...
    for video_link, rand_time in videos.items():
      for rand_resolution in [1080, 720, 480, 360]:
        ...
        for i in range(7):
          ...
          unplug()
          quit_youtube()
          launch_youtube_with_link(args.video_link)
          time.sleep(2)
